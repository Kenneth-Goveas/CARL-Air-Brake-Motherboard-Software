...
#define BNO055_PUT_BITS(reg, bit, val) \
...
typedef enum {
    axis_px = (BNO055_PRST_SGN_P << 8) | BNO055_PRST_MAP_X,
    axis_nx = (BNO055_PRST_SGN_N << 8) | BNO055_PRST_MAP_X,
    axis_py = (BNO055_PRST_SGN_P << 8) | BNO055_PRST_MAP_Y,
    axis_ny = (BNO055_PRST_SGN_N << 8) | BNO055_PRST_MAP_Y,
    axis_pz = (BNO055_PRST_SGN_P << 8) | BNO055_PRST_MAP_Z,
    axis_nz = (BNO055_PRST_SGN_N << 8) | BNO055_PRST_MAP_Z
} axis;
