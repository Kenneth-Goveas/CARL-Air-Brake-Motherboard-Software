...
class ivector {
    public:
        ...
        friend std::tuple<fmatrix, fmatrix, fmatrix> plu (const fmatrix & mat);
        friend std::tuple<fmatrix, fmatrix> qr (const fmatrix & mat);
        friend std::tuple<fmatrix, fmatrix> rq (const fmatrix & mat);
        friend std::tuple<fmatrix, fmatrix> ql (const fmatrix & mat);
        friend std::tuple<fmatrix, fmatrix> lq (const fmatrix & mat);
        friend std::tuple<fmatrix, fmatrix> qdq (const fmatrix & mat);
